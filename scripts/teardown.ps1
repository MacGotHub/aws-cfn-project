...
Write-Host "Waiting for On-Prem stacks to delete..." -ForegroundColor Yellow
Start-Sleep -Seconds 60
...
Write-Host "Monitor progress in the AWS Console." -ForegroundColor Yellow
Write-Host "All stacks should be deleted within 15-20 minutes." -ForegroundColor Yellow